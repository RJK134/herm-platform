...
export function HowItWorks() {
  ...
  return (
    <div>
      <Header title="How It Works" subtitle="Scoring methodology, evidence standards, and framework explanation" />
      ...
      <div className="flex gap-1 mb-6 bg-gray-100 dark:bg-gray-800 p-1 rounded-xl w-fit">
        {TABS.map(tab => (
          <button
            ...
            className={`px-4 py-2 text-sm rounded-lg font-medium transition-colors ${activeTab === tab ? 'bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700'}`}
          >
            {tab}
          </button>
        ))}
      ...
      {activeTab === 'Scoring Model' && (
        <div className="space-y-6">
          ...
          <Card>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Score Calculation</h3>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 font-mono text-sm">
              <div>Coverage % = (Sum of all capability scores) ÷ (Number of capabilities × 100) × 100</div>
              <div className="text-gray-400 mt-1">e.g., 8,500 ÷ (165 × 100) × 100 = 51.5%</div>
            </div>
