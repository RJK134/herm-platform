...
//   2. Long name pins to "Future Horizons Education Procurement Platform"
...
describe('PRODUCT branding (Phase 16.1)', () => {
  ...
  it('uses "Future Horizons Education Procurement Platform" as the long name', () => {
    expect(PRODUCT.longName).toBe('Future Horizons Education Procurement Platform');
