...
// in `client/src/lib/navigation.ts` (`tier: ['professional', 'enterprise']`)
// and the IA table in HERM_COMPLIANCE.md "Navigation and IA". The previous
...
// SUBSCRIPTION_REQUIRED with `details.requiredTiers: ['professional',
// 'enterprise']`, matching the rest of the paid-feature surface.
router.use(authenticateJWT, requirePaidTier(['professional', 'enterprise']));
